...
(function (Scratch) {
  ...
  runtime.startHats = function (opcode, fields, target) {
    ...
    if (opcode === "event_whenbroadcastreceived") {
      const broadcastName = fields.BROADCAST_OPTION;
      delete fields.BROADCAST_OPTION;
      vm.runtime.spLastMessageSent = broadcastName;
      const spThreads = originalStartHats.call(
        this,
        "SPmessagePlus_whenBroadcastReceived",
        fields,
        target
      );
      if (spThreads) {
        threads = [...threads, ...spThreads];
      }
      threads.forEach((thread) => {
        thread.broadcastName = broadcastName;
      });
    }
    return threads;
  };
  ...
  class SPmessagePlus {
      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            xml: `
            <block type="SPmessagePlus_whenBroadcastReceived"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value></block>
            `,
          },
          {
    ...
    whenBroadcastReceived(args) {
      ...
      return broadcastOption === runtime.spLastMessageSent;
    }
